...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="{{URL::asset('public/vendor/morrisjs/morris.css')}}" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="{{URL::asset('public/vendor/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{URL::asset('public/sweetalert/sweetalert2.min.css')}}" rel="stylesheet">
...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="morris.html">Sales Order</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="panels-wells.html">Report</a>
                                </li>
                                <li>
                                    <a href="user">Users</a>
                                </li>
                                <li>
                                    <a href="notifications.html">Purchasers</a>
                                </li>
                                <li>
    ...
    <script src="{{URL::asset('public/sweetalert/sweetalert2.min.js')}}"></script>
